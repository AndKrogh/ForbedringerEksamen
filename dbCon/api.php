<?php
    ...
    if($action=='jointasks'){
        ...
        $sql = "SELECT tasks.navn, tasks.taskStatus, tasks.beskrivelse, kommentar.kommentar, tasks.dato, tasks.bedømmelse_id, bedømmelse.bedømmelse, bedømmelse.bedømmelse_id
